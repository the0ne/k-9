...
public class ResentMessageBuilder extends MessageBuilder {
    ...
    private String resentOriginalReturnPath;
    ...
    public ResentMessageBuilder setResentOriginalReturnPath(String resentOriginalReturnPath) {
        this.resentOriginalReturnPath = resentOriginalReturnPath;
        return this;
    }
    ...
    protected void buildMessageInternal() {
        ...
        message.setResentOriginalReturnPath(new Address(resentOriginalReturnPath));
