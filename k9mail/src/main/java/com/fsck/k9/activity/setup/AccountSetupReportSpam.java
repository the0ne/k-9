...
public class AccountSetupReportSpam extends K9Activity {
    ...
    private EditText mAccountReportHamRecipient;
    private EditText mAccountReportHamSubject;
    private CheckBox mAccountReportHamDelete;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean spamDelete = mAccount.isReportSpamDelete();
        mAccountReportSpamDelete.setChecked(spamDelete);

        mAccountReportHamRecipient = (EditText)findViewById(R.id.account_reportham_recipient);
        mAccountReportHamRecipient.setText(mAccount.getReportHamRecipient());

        mAccountReportHamSubject = (EditText)findViewById(R.id.account_reportham_subject);
        mAccountReportHamSubject.setText(mAccount.getReportHamSubject());

        mAccountReportHamDelete = (CheckBox)findViewById(R.id.account_reportham_delete);
        boolean hamDelete = mAccount.isReportHamDelete();
        mAccountReportHamDelete.setChecked(hamDelete);
    }
    ...
    private void saveSettings() {
        ...
        mAccount.setReportHamRecipient(mAccountReportHamRecipient.getText().toString());
        mAccount.setReportHamSubject(mAccountReportHamSubject.getText().toString());
        mAccount.setReportHamDelete(mAccountReportHamDelete.isChecked());
